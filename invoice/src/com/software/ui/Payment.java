...
public class Payment extends javax.swing.JFrame {
    ...
    public void savePayment()
    {
        ...
        String query="insert into payment(transaction_date,seller_no,invoice_no,invoice_amt,payment_amt,reference) values(str_to_date('"+paymentDate+"','%d-%m-%Y'),'"+sellerCode+"','"+invoiceNumber+"','"+invoiceAmt+"','"+paymentAmt+"','"+reference+"')";
    try{
        Connection conn=new ConnDB().make_connection();
        Statement stmt=conn.createStatement();
        stmt.executeUpdate(query);
        JOptionPane.showMessageDialog(this, "Payment Info updted");
        this.dispose();
        new Payment().setVisible(true);
